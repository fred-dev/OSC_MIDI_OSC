...
void ofApp::newMidiMessage(ofxMidiMessage & msg) {
	...
	if (midiMessage.status == MIDI_SYSEX) {
		...
		if (midiMessage.bytes[3] == 0x02) {
			...
			ofLogVerbose() << "Midi Show Control Message" << endl;
			ofLogVerbose() << "Command: " + getMidiShowControlCommandType(midiMessage.bytes[5]) << endl;
			ofLogVerbose() << "Target: " + getMidiShowControTargetType(midiMessage.bytes[4]) << endl;
			ofLogVerbose() << "Device ID: " + ofToString(deviceId) << endl;
			ofLogVerbose() << "Command Data: " << endl;
			for (int i = 0; i < getMidiShowControlCommandData(midiMessage).size(); i++) {
				ofLogVerbose() << "Data Byte " + ofToString(i) + ": " + ofToString(getMidiShowControlCommandData(midiMessage)[i]) << endl;
			}
		}
...
string ofApp::getMidiShowControTargetType(uint8_t byte) {

	string targetType;
	switch (byte) {
	case 0x01:
		ofLogVerbose() << "Midi Show Control Message Lighting" << endl;
		targetType = "lighting";
		break;
	case 0x02:
		ofLogVerbose() << "Midi Show Control Message Moving Light" << endl;
		targetType = "moving light";
		break;
	case 0x03:
		ofLogVerbose() << "Midi Show Control Message Color Changer" << endl;
		targetType = "color changer";
		break;
	case 0x04:
		ofLogVerbose() << "Midi Show Control Message Strobe" << endl;
		targetType = "strobe";
		break;
	case 0x05:
		ofLogVerbose() << "Midi Show Control Message Lasers" << endl;
		targetType = "lasers";
		break;
	case 0x06:
		ofLogVerbose() << "Midi Show Control Message Chasers" << endl;
		targetType = "chasers";
		break;
	case 0x07:
		ofLogVerbose() << "Midi Show Control Message Sound" << endl;
		targetType = "sound";
		break;
	case 0x08:
		ofLogVerbose() << "Midi Show Control Message Projection" << endl;
		targetType = "projection";
		break;
	case 0x09:
		ofLogVerbose() << "Midi Show Control Message Smoke" << endl;
		targetType = "smoke";
		break;
	case 0x0A:
		ofLogVerbose() << "Midi Show Control Message Bubbles" << endl;
		targetType = "bubbles";
		break;
	case 0x0B:
		ofLogVerbose() << "Midi Show Control Message Projector" << endl;
		targetType = "projector";
		break;
	case 0x0C:
		ofLogVerbose() << "Midi Show Control Message Flame" << endl;
		targetType = "flame";
		break;
	case 0x0D:
		ofLogVerbose() << "Midi Show Control Message Water" << endl;
		targetType = "water";
		break;
	case 0x0E:
		ofLogVerbose() << "Midi Show Control Message Fog" << endl;
		targetType = "fog";
		break;
	case 0x0F:
		ofLogVerbose() << "Midi Show Control Message Bubbles" << endl;
		...
		break;
	case 0x10:
		ofLogVerbose() << "Midi Show Control Message Snow" << endl;
		targetType = "snow";
		break;
	case 0x11:
		ofLogVerbose() << "Midi Show Control Message Wind" << endl;
		targetType = "wind";
		break;
	case 0x12:
		ofLogVerbose() << "Midi Show Control Message Rain" << endl;
		targetType = "rain";
		break;
	case 0x13:
		ofLogVerbose() << "Midi Show Control Message Fireworks" << endl;
		targetType = "fireworks";
		break;
	case 0x14:
		ofLogVerbose() << "Midi Show Control Message Explosions" << endl;
		targetType = "explosions";
		break;
	case 0x15:
		ofLogVerbose() << "Midi Show Control Message Pyro" << endl;
		targetType = "pyro";
		break;
	case 0x16:
		ofLogVerbose() << "Midi Show Control Message Fire" << endl;
		targetType = "fire";
		break;
	case 0x17:
		ofLogVerbose() << "Midi Show Control Message CO2" << endl;
		targetType = "CO2";
		break;
	case 0x18:
		ofLogVerbose() << "Midi Show Control Message Nitrogen" << endl;
		targetType = "nitrogen";
		break;
	case 0x19:
		ofLogVerbose() << "Midi Show Control Message Argon" << endl;
		targetType = "argon";
		break;
	case 0x1A:
		ofLogVerbose() << "Midi Show Control Message Confetti" << endl;
		targetType = "confetti";
		break;
	case 0x1B:
		ofLogVerbose() << "Midi Show Control Message Streamers" << endl;
		targetType = "streamers";
		break;
	case 0x1C:
		ofLogVerbose() << "Midi Show Control Message Banners" << endl;
		targetType = "banners";
		break;
	case 0x1D:
		ofLogVerbose() << "Midi Show Control Message Flags" << endl;
		targetType = "flags";
		break;
	case 0x1E:
		ofLogVerbose() << "Midi Show Control Message Balloons" << endl;
		targetType = "balloons";
		break;
	case 0x1F:
		ofLogVerbose() << "Midi Show Control Message Machines" << endl;
		targetType = "machines";
		break;
	case 0x20:
		ofLogVerbose() << "Midi Show Control Message Fans" << endl;
		targetType = "fans";
		break;
	case 0x21:
		ofLogVerbose() << "Midi Show Control Message Motors" << endl;
		targetType = "motors";
		break;
	case 0x22:
		ofLogVerbose() << "Midi Show Control Message Water Jets" << endl;	
		targetType = "water jets";
		break;
	case 0x23:
		ofLogVerbose() << "Midi Show Control Message Bubbles" << endl;
		targetType = "bubbles";
	...
	//we need a function to check the command bit of the midi show control message
//command types can be found here http://www.midi.org/techspecs/midimessages.php
//lets use a switch statement to check the command byte

string ofApp::getMidiShowControlCommandType(uint8_t byte) {

	string commandType;
	switch (byte) {
	case 0x01:
		ofLogVerbose() << "Midi Show Control Message go" << endl;
		commandType = "go";
		break;
	case 0x02:
		ofLogVerbose() << "Midi Show Control Message stop" << endl;
		commandType = "stop";
		break;
	case 0x03:
		ofLogVerbose() << "Midi Show Control Message resume" << endl;
		commandType = "resume";
		break;
	case 0x04:
		ofLogVerbose() << "Midi Show Control Message timed go" << endl;
		commandType = "timed go";
		break;
	case 0x05:
		ofLogVerbose() << "Midi Show Control Message load" << endl;
		commandType = "load";
		break;
	case 0x06:
		ofLogVerbose() << "Midi Show Control Message set" << endl;
		commandType = "set";
		break;
	case 0x07:
		ofLogVerbose() << "Midi Show Control Message Lighting fire" << endl;
		commandType = "fire";
		break;
	case 0x08:
		ofLogVerbose() << "Midi Show Control Message Lighting all off" << endl;
		commandType = "all off";
		break;
	case 0x09:
		ofLogVerbose() << "Midi Show Control Message Lighting restore" << endl;
		commandType = "restore";
		break;
	case 0x0A:
		ofLogVerbose() << "Midi Show Control Message Lighting reset" << endl;
		commandType = "reset";
		break;
	case 0x0B:
		ofLogVerbose() << "Midi Show Control Message Lighting go off" << endl;
		commandType = "go off";
		break;
	case 0x0C:
		ofLogVerbose() << "Midi Show Control Message Lighting standby" << endl;
		commandType = "standby";
		break;
	case 0x0D:
		ofLogVerbose() << "Midi Show Control Message Lighting sequence" << endl;
		commandType = "sequence";
		break;
	case 0x0E:
		ofLogVerbose() << "Midi Show Control Message Lighting go to" << endl;
		commandType = "go to";
		break;
	case 0x0F:
		ofLogVerbose() << "Midi Show Control Message Lighting time code" << endl;
		commandType = "time code";
		break;
	default:
		ofLogVerbose() << "Midi Show Control Message Lighting unknown" << endl;
		commandType = "unknown";
		break;
	}
	return commandType;
